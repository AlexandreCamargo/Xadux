...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMiddle" runat="server">
    ...
    <div id="divBtoEnviar">
        ...
        <div id="div_addThis" class="addthis_toolbox addthis_default_style addthis_32x32_style">
            ...
            </a>&nbsp;<asp:ImageButton ID="bto_denuncie" ImageUrl="~/Imagens/iconeDenuncie.png"
                title="Denuncie!" AlternateText="Denuncie" runat="server" OnClick="bto_denuncie_Click" />
        </div>
    ...
    <asp:UpdatePanel ID="updMenuAbas" runat="server">
        <ContentTemplate>
            <div>
                ...
                <asp:View ID="view_multimedia" runat="server">
                    <div style="background: #333333; text-align: center;">
                        <asp:Repeater ID="rept_videos" runat="server">
                            <ItemTemplate>
                                <br />
                                <asp:Literal ID="lit_videos" runat="server" Text='<%#Eval("URL") %>'></asp:Literal><br />
                                <br />
                            </ItemTemplate>
                        </asp:Repeater>
                        <br style="clear: both;" />
            ...
            <ItemTemplate>
                <div style="background-color: #F8F8F8; font-family: Verdana; margin-bottom: 2px;">
                    ...
                    <div style="float: right">
                        ...
                        <asp:ImageButton ID="bto_download" runat="server" ImageUrl="~/Imagens/imgSetaDownload.jpg"
                            CommandArgument='<%# Eval("Id") %>' OnClick="bto_download_Click" />
                    </div>
