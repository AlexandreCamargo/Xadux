...
{
    public class EstiloMusicalDal : DalBase
    {
        public XaduxClassLibrary.EstiloMusical Inserir(XaduxClassLibrary.EstiloMusical estiloMusical)
        {
            try
            {
        ...
        public List<XaduxClassLibrary.EstiloMusical> Consultar()
        {
            var estilosList =
        ...
        public XaduxClassLibrary.EstiloMusical Consultar(string nome)
        {
            var estilosList =
                from estilos in entidade.EstiloMusical
        ...
        public XaduxClassLibrary.EstiloMusical Consultar(int id)
        {
            var estilosList =
                from estilos in entidade.EstiloMusical
                where estilos.Id == id
        ...
        /// </summary>
        /// <returns></returns>
        public List<XaduxClassLibrary.EstiloMusical> ConsultarComBandas()
        {
            //List<int> listIdsMusicaBandas = new List<int>();
            using (EstiloMusicalDal listIdsMusicaBandas = new EstiloMusicalDal())
            {
        ...
        /// <returns></returns>
        public List<XaduxClassLibrary.EstiloMusical> Listar(List<int> listaIdsEstilosMusicais)
        {
            var estilosList =
                from estilos in entidade.EstiloMusical
