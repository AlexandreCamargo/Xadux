...
{
    public class BandaDal : DalBase
    {
        
        public Banda Inserir(Banda banda)
        {
            try
            {
        ...
        public void AdicionarFa(int bandaId, int usuarioId)
        {
        ...
        public void AdicionarAcesso(XaduxClassLibrary.AcessosBanda acessos)
        {
            try
            {
        ...
        /// <returns></returns>
        public XaduxClassLibrary.Banda Consultar(string nome)
        {
            var bandasList =
        ...
        /// <param name="nome"></param>
        /// <returns></returns>
        public XaduxClassLibrary.Banda Consultar(int idBanda)
        {
            var bandasList =
                from bandas in entidade.Banda
        ...
        public List<XaduxClassLibrary.Banda> Buscar(int top, string busca)
        {
            var bandasList =
                from bandas in entidade.Banda
        ...
        public List<XaduxClassLibrary.Banda> Buscar(int top, int idEstiloMusical)
        {
            var bandasList =
                from bandas in entidade.Banda
        ...
        /// <returns></returns>
        public List<XaduxClassLibrary.Banda> ListarMaisAcessadas(int topMaisAcessadas)
        {
            
            //List<int> listIdsBandas = new List<int>();
            using (BandaDal listIdsBandas = new BandaDal())
            {
        ...
        /// <returns></returns>
        public List<XaduxClassLibrary.Banda> ListarMaisAcessadas(int topMaisAcessadas, int idEstiloMusical)
        {
            List<int> listIdsBandas = new List<int>();
            SqlConnection conexao = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["xaduxDataBase"].ConnectionString);
        ...
        /// <returns></returns>
        public List<XaduxClassLibrary.Banda> Listar(List<int> listaIdsBandas)
        {
            var bandasList =
                from bandas in entidade.Banda
        ...
        public List<XaduxClassLibrary.Banda> BuscarAleatorias(int top, int estiloMusicalId)
        {
            List<int> listIdsBandas = new List<int>();
            SqlConnection conexao = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["xaduxDataBase"].ConnectionString);
